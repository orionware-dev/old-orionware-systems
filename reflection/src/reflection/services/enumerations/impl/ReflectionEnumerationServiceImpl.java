package reflection.services.enumerations.impl;

import reflection.services.ReflectionServiceObject;
import reflection.services.enumerations.ReflectionEnumerationService;
import reflection.services.enumerations.impl.tasks.GetEnumerationDefinitionsTask;
import reflection.services.enumerations.impl.tasks.GetEnumerationNameTask;
import reflection.services.enumerations.impl.tasks.GetEnumerationValueTask;
import reflection.services.enumerations.impl.tasks.InstantiateEnumerationTask;
