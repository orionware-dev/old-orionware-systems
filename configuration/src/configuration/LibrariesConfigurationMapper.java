...
public class LibrariesConfigurationMapper extends OrionMapper
{
    ...
    public static ConcurrentMap<String, Boolean> LIBRARIES_AND_IF_PROPERTIES_HAS_BEEN_REGISTERED_MAPPER;
    ...
    static
    {
        ...
        LIBRARIES_AND_IF_PROPERTIES_HAS_BEEN_REGISTERED_MAPPER = new ConcurrentHashMap<String, Boolean>();
    }
}