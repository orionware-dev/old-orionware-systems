...
public final class ConcurrentSuite extends Suite
{
    ...
    {
        super(aClass, new AllDefaultPossibilitiesBuilder(true)
        {
            @Override
        ...
        {
            ExecutorService executorService = Executors.newFixedThreadPool(aClass.isAnnotationPresent(Concurrent.class) ? aClass.getAnnotation(Concurrent.class).threads() : (int)(Runtime.getRuntime().availableProcessors() * 1.5), new NamedThreadFactory(aClass.getSimpleName()));
