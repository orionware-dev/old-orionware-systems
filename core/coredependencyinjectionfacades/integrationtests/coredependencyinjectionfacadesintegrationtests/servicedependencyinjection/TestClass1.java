...
public class TestClass1 extends OrionObject
{
    ...
    {
        return "Running coredependencyinjectionfacadesintegrationtests.servicedependencyinjection.TestClass1...";
    }
    ...
    @Injector(ID = "coredependencyinjectionfacadesintegrationtests.servicedependencyinjection.TestClass2")
