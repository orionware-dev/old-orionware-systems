...
public class TestClass1 extends OrionObject
{
    ...
    {
        return "Running coredependencyinjectionfacadesintegrationtests.dependencyinjection.TestClass1...";
    }
    ...
    @Injector(ID = "coredependencyinjectionfacadesintegrationtests.dependencyinjection.TestClass2")
