...
public class LibrariesConfigurationMapper extends OrionMapper
{
    ...
    public static ConcurrentMap<String, Boolean> LIBRARIES_AND_IF_CONFIGURATION_HAVE_BEEN_REGISTERED_MAPPER;
    //public static ConcurrentMap<String, Boolean> LIBRARIES_AND_IF_ANNOTATIONS_HAVE_BEEN_REGISTERED_MAPPER;
    
    
    static
    {
        LIBRARIES_AND_IF_CONFIGURATION_HAVE_BEEN_REGISTERED_MAPPER = new ConcurrentHashMap<String, Boolean>();
