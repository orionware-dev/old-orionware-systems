...
{
    LIBRARY_NAME("coreconfiguration"), LIBRARY_CLASS_PATH("/core"), LIBRARY_CONFIGURATION_DIR("" + LIBRARY_CLASS_PATH.get() + "/" + DefaultConfigurationEnumeration.DEFAULT_CONFIGURATION_DIR.get()),
