...
public class DesignPatternsConfiguration extends OrionConfiguration
{
    ...
    public String PIPELINE_CONFIGURATION_FILE_PATH;
    ...
    public DesignPatternsConfiguration()
    {
        BIN_DIR = "bin";
        ...
        PIPELINE_CONFIGURATION_FILE_PATH = "/" + DEFAULT_CONFIGURATION_DIR + "/Pipeline.prop";
